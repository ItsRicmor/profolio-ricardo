...
export function ExperienceItem({ experience, index }: ExperienceItemProps) {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "relative pl-6 pb-10 last:pb-0 ml-8 transition-all duration-600 ease-out",
        isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
      )}
    >
      {/* Node with index */}
      <div className="absolute -left-[33px] top-0 flex items-center justify-center h-6 w-6 rounded-md border border-primary/30 bg-background">
      ...
      <div className="absolute left-0 top-[11px] w-3 h-px bg-primary/20" />
